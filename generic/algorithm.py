...
class Algorithm(object):
    ...
    def __init__(self, prob, x0):
        ...
        pramètres : un probleme, et une solution initial.
        """
        if not isinstance(x0, Solution):
            raise TypeError("x0 must be a instance of Solution")
